...
const eventos = defineCollection({
	...
	schema: z.object({
		...
		officialWoMakersCode: z.boolean().optional(),
		officialCafeEmCodigo: z.boolean().optional(),
		officialAWS: z.boolean().optional(),
		artificialIntelligence: z.boolean().optional(),
		devops: z.boolean().optional(),
		cloudAiInnovation: z.boolean().optional(),
